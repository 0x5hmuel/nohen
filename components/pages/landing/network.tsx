...
const Network = () => {
  ...
  return (
    <section id="network" className="p-17.5 bg-white space-y-12 overflow-hidden">
      ...
      <div id="supportedBrands" className="relative space-y-8">
        ...
        <div className="flex w-max animate-marquee gap-16 items-center">
          {[...row1, ...row1, ...row1, ...row1].map((Brand, index) => (
            <div key={index} className="flex-shrink-0 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
