  ...
  return (
    <div className="w-full relative h-screen z-50">
      ...
      <div className="absolute top-16 pl-5 flex flex-col uppercase">
        <p
          className="text-[437.79px] bg-gradient-to-r  relative to-[#EFBF04]/5 from-[#ffffff]/5 bg-clip-text text-transparent"
      ...
      <div className="md:w-325 font-extrabold z-999999 space-y-5 relative -bottom-80 -right-15">
        ...
        <p className="md:w-4/6 font-normal text-white font-satoshi " style={{
          letterSpacing: "-6%",
          lineHeight: "108%",
          fontSize: "25px"
        }}>{description}</p>
