...
const Page = () => {
  ...
  return (
    <section id="services">
      <Hero title="Technical Expertise for Demanding Projects." description="Our mission is simple, to provide unparalleled expertise, guidance, and support to our clients across their real estate journey." buttonText="Call Us Today" alt="" image={ServicesHero} buttonLink="" metaText="" isLink={true} key={"services"} />
